...
const ListItem = (props) => {
  ...
  return (
    <Flex
      flexDirection="row"
      background={colorMode === "light" ? "#d2eef3" : "#4A5568"}
      width="100%"
      justifyContent="space-around"
      alignItems="center"
      position="relative"
      right="4px"
      border={colorMode === "light" ? "2px solid #a4f2ff" : "2px solid #718096"}
      borderRadius="6px"
      boxShadow={
        colorMode === "light" ? "2px 2px 2px #90efff" : "2px 2px 2px #A0AEC0"
      }
      margin="4px"
    >
      <Checkbox
      ...
      ></Checkbox>
      <Text
        color={colorMode === "light" ? "white.800" : "white"}
